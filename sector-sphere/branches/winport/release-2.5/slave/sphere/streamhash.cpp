...
#ifdef WIN32
    #ifdef STREAMHASH_EXPORTS
        #define STREAMHASH_API __declspec(dllexport)
    #else
        #define STREAMHASH_API __declspec(dllimport)
    #endif
#else
    #define STREAMHASH_API
#endif
...
int STREAMHASH_API streamhash(const SInput* input, SOutput* output, SFile* file)
{
