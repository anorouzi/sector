...
int SOutput::resizeResBuf(const int& newsize)
{
   ...
   try
   {
      tmp = new char[static_cast<size_t>(newsize)];
   }
   catch (...)
   {
      return -1;
   ...
   m_iBufSize = static_cast<int>(newsize);
...
int SOutput::resizeIdxBuf(const int& newsize)
{
   ...
   try
   {
      tmp1 = new int64_t[static_cast<size_t>(newsize)];
      tmp2 = new int[static_cast<size_t>(newsize)];
   }
   catch (...)
   {
      return -1;
   ...
   m_iIndSize = static_cast<int>(newsize);
